...
adp.trialFieldsDisplay = {
  ...
  init : function() {
    ...
    adp.trialFieldsDisplay.regex = /(Appeal against conviction|Appeal against sentence|Breach of Crown Court order|Committal for Sentence|Contempt|Cracked Trial|Cracked before retrial|Elected cases not proceeded).*/i;
