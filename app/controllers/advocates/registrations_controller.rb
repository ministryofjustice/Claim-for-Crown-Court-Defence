class Advocates::RegistrationsController < Devise::RegistrationsController
  ...
  def check_environment
    redirect_to advocates_root_url unless Rails.host.api_sandbox?
  end
