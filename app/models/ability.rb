  ...
  def initialize(user)
    ...
    if persona.is_a? ExternalUser
      if persona.admin?
        ...
        can [:show, :show_message_controls, :edit, :update, :summary, :confirmation, :clone_rejected, :destroy], Claim::BaseClaim, provider_id: persona.provider_id
        ...
        can [:create], ClaimIntention
        can [:index, :outstanding, :authorised, :archived, :new, :create], Claim::BaseClaim
        can [:show, :show_message_controls, :edit, :update, :summary, :confirmation, :clone_rejected, :destroy], Claim::BaseClaim, external_user_id: persona.id
