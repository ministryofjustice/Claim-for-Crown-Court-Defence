...
module Claim
  class TransferClaim < BaseClaim
    ...
    #
    DELEGATED_ATTRS = [:litigator_type, :elected_case, :transfer_stage_id, :transfer_date, :transfer_date_dd, :transfer_date_mm, :transfer_date_yyyy, :case_conclusion_id].freeze
