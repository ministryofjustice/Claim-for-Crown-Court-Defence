module TimedTransitions
  class BatchTransitioner
    ...
    def log_end
      slack.build_payload(processed: @transitions_counter, failed: @failed_transitions)
      slack.send_message
    ...
    def slack
      @slack ||= SlackNotifier.new('laa-cccd-alerts', formatter: SlackNotifier::Formatter::Transitioner.new)
    end
  end
end
