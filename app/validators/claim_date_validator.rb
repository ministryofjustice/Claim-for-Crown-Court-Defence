...
class ClaimDateValidator < BaseClaimValidator
  ...
  def validate_trial_fixed_notice_at
    validate_presence(:trial_fixed_notice_at, "Please enter valid date notice of first fixed/warned issued") if @record.case_type.requires_cracked_dates?
  ...
  def validate_trial_fixed_at
    validate_presence(:trial_fixed_at, "Please enter valid date first fixed/warned") if @record.case_type.requires_cracked_dates?
  ...
  def validate_trial_cracked_at
    validate_presence(:trial_cracked_at, "Please enter valid date when case cracked") if @record.case_type.requires_cracked_dates?
  ...
  def validate_first_day_of_trial
    validate_presence(:first_day_of_trial, "Please enter a valid date for first day of trial") if @record.case_type.requires_trial_dates?
    ...
    validate_not_before(5.years.ago, :first_day_of_trial, "First day of trial must not be more than 5 years ago")
  end
