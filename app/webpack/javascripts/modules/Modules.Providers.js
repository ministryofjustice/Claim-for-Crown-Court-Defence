moj.Modules.Providers = {
  init: function () {
    ...
    $.subscribe('/scheme/type/agfs/', function (e, obj) {
      const provider = $('#provider_provider_type_chamber').is(':checked') ? 'chamber' : 'firm'
      const $agfs = $('#provider_roles_agfs').is(':checked')
    ...
    $.subscribe('/scheme/type/lgfs/', function (e, obj) {
      const provider = $('#provider_provider_type_chamber').is(':checked') ? 'chamber' : 'firm'
      const $lgfs = $('#provider_roles_lgfs').is(':checked')
