...
ActiveRecord::Schema[7.0].define(version: 2024_12_03_142017) do
  ...
  create_table "message_documents", force: :cascade do |t|
    ...
    t.index ["creator_id"], name: "index_message_documents_on_creator_id"
    t.index ["external_user_id"], name: "index_message_documents_on_external_user_id"
    t.index ["message_id"], name: "index_message_documents_on_message_id"
  end
