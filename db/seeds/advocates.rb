...
if User.find_by(email: 'advocate@example.com').blank?
  ...
  advocate = Advocate.new(role: 'advocate', chamber_id: chamber.id, account_number: 'AB234')
  advocate.user = user
  advocate.save!
end
...
if User.find_by(email: 'advocateadmin@example.com').blank?
  ...
  advocate = Advocate.new(role: 'admin', chamber_id: chamber.id, account_number: 'XY234')
  advocate.user = user
  advocate.save!
end
