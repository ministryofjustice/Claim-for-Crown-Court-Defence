...
csv.each do |row|
  ...
  Offence.find_or_create_by!(offence_class: offence_class, description: description, unique_code: DataMigrator::OffenceCodeSeeder.new(description, class_letter).unique_code)
end
