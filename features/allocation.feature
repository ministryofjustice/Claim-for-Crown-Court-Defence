...
Feature: Case worker admin allocates claims 
  ...
  Scenario: I allocate claims, case worker sees them
    ...
    #And claims "T00000001, T00000002" should no longer be displayed -- TODO: pending until remote allocations are implemented
    And I should see '2 claims allocated to John Smith'
    And I sign out

    When I sign in as John Smith
    Then I should be on the 'Your claims' page
    #And claims "T00000001, T00000002" should appear on the page -- TODO: pending until remote allocations are implemented
