...
#TO DO: this tests that transition to draft is not displayed.  We can do this with a unit test in claim history.
...
@javascript @webmock_allow_localhost_connect
Scenario Outline: Advocate clicking seeing messages control and can send messages
  Given I am a signed in advocate
    And I have 1 <state> claim
   When I visit that claim's "advocate" detail page
