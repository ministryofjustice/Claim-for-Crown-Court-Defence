@javascript
Feature: Advocate tries to submit a hardship claim for a trial with miscellaneous fees
  ...
  Scenario: I create a hardship claim for a trial
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_eleven/hardship_fee_calculations'
