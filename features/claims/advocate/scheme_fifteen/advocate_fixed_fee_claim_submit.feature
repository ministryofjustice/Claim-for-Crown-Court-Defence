@javascript
Feature: Advocate tries to submit a fee scheme 15 claim for a Fixed fee (Appeal against conviction)
  ...
  Scenario: I create an Appeal against conviction claim, and use the back button to invalidate it
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_fifteen/fixed_fee_calculations'
