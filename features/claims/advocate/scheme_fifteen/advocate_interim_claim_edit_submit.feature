@javascript
Feature: Advocate partially fills out a draft AGFS scheme 15 interim claim for a warrant fee, then later edits and submits it

  Scenario: I create an AGFS interim claim, save it to draft and later complete it

    Given the current date is '2023-12-01'
    ...
    And I fill in '2023-04-30' as the warrant issued date
