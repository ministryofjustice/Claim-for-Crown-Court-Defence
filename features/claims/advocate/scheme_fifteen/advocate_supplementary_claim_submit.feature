@javascript
Feature: Advocate tries to submit a fee scheme 15 supplementary claim for miscellaneous fees (only)
  ...
  Scenario: I create a supplementary claim but skip adding only applicable misc fees
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_fifteen/supplementary_fee_calculations'
