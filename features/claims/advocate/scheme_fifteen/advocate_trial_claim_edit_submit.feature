@javascript
Feature: Advocate creates, saves, edits then submits a claim for a final fee trial case under scheme 15
  ...
  Scenario: Successful submission
    ...
    And I enter scheme 15 trial start and end dates
    ...
    When I enter defendant, scheme 15 representation order and MAAT reference
    ...
    And I insert the VCR cassette 'features/claims/advocate/scheme_fifteen/trial_claim_edit'
