@javascript
Feature: Advocate can add and remove fee scheme 15 miscelleaneous fees

  @fee_calc_vcr
  Scenario: Advocate can add and remove miscellaneous fees

    Given I am a signed in advocate
    And the current date is '2023-05-01'
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_fifteen/misc_fee_removal'
