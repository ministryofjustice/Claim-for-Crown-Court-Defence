@javascript
Feature: Advocate submits an AGFS Fee Scheme 17 hardship claim for a trial with miscellaneous fees
  ...
  Scenario: I create a hardship claim for a trial
    ...
    And I enter scheme 17 trial start date
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_seventeen/hardship_fee_calculations'
    ...
    And I add a govuk calculated miscellaneous fee 'Additional preparation fee' with quantity of '1'
