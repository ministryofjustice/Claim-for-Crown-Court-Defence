@javascript
Feature: Advocate submits a fee scheme 17 supplementary claim for miscellaneous fees (only)
  ...
  Scenario: I create a supplementary claim and add applicable misc fees
    ...
    And I add another defendant, scheme 17 representation order and MAAT reference

    Given I insert the VCR cassette 'features/claims/advocate/scheme_seventeen/supplementary_fee_calculations'
    ...
    And the following miscellaneous fee checkboxes should exist:
      ...
      | miscellaneous | Section 28 hearing                       |
    ...
    And I choose the 'Section 28 hearing' miscellaneous fee with quantity of '1'
    ...
    And the following check your claim fee details should exist:
      ...
      | miscellaneous-fees-section | 1   | Rate        | 81.00                                   |
      | miscellaneous-fees-section | 1   | Net amount  | 81.00                                   |
      ...
      | miscellaneous-fees-section | 4   | Net amount  | 42.00                                   |
      | miscellaneous-fees-section | 5   | Type of fee | Wasted preparation fee                  |
      | miscellaneous-fees-section | 5   | Quantity    | 1                                       |
      | miscellaneous-fees-section | 5   | Rate        | 45.30                                   |
      | miscellaneous-fees-section | 5   | Net amount  | 45.30                                   |
      | miscellaneous-fees-section | 6   | Type of fee | Standard appearance fee                 |
      | miscellaneous-fees-section | 6   | Quantity    | 2                                       |
      | miscellaneous-fees-section | 6   | Rate        | 105.00                                  |
      | miscellaneous-fees-section | 6   | Net amount  | 210.00                                  |
    ...
    And Claim 'A20191234' should be listed with a status of 'Submitted' and a claimed amount of '£2,130.31'
