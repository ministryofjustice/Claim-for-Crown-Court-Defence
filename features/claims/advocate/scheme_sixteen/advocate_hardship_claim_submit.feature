@javascript
Feature: Advocate tries to submit a fee scheme 16 hardship claim for a trial with miscellaneous fees
  ...
  Scenario: I create a hardship claim for a trial
    ...
    And I enter scheme 16 trial start date
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_sixteen/hardship_fee_calculations'
