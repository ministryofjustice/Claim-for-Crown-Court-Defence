@javascript
Feature: Advocate partially fills out a draft AGFS scheme 16 interim claim for a warrant fee, then later edits and submits it

  Scenario: I create an AGFS interim claim, save it to draft and later complete it

    Given the current date is '2024-02-16'
    ...
    And I fill in '2023-11-16' as the warrant issued date
