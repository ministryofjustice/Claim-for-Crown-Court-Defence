@javascript
Feature: Advocate tries to submit a fee scheme 16 supplementary claim for miscellaneous fees (only)
  ...
  Scenario: I create a supplementary claim but skip adding only applicable misc fees
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_sixteen/supplementary_fee_calculations'
    ...
    And I add an expense date for scheme 16
