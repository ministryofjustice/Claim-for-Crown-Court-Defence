@javascript
Feature: Advocate creates, saves, edits then submits a claim for a final fee trial case under scheme 16
  ...
  Scenario: Successful submission
    ...
    And I enter scheme 16 trial start and end dates
    ...
    When I enter defendant, scheme 16 representation order and MAAT reference
    ...
    And I insert the VCR cassette 'features/claims/advocate/scheme_sixteen/trial_claim_edit'
    ...
    And I should see the scheme 16 applicable basic fees based on the govuk checkbox group
