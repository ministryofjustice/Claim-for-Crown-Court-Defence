@javascript
Feature: Advocate chooses fee scheme 16 offences and clears them
  ...
  Background:
    ...
    Given I enter defendant, scheme 16 representation order and MAAT reference
    And I click "Continue" in the claim form
    Then I should be in the 'Offence details' form page

  Scenario: Choosing scheme 16 offences
