@javascript
Feature: Advocate tries to submit a fee scheme 13 hardship claim for a trial with miscellaneous fees
  ...
  Scenario: I create a hardship claim for a trial
    ...
    And I enter scheme 13 trial start date
    ...
    Given I insert the VCR cassette 'features/claims/advocate/scheme_thirteen/hardship_fee_calculations'
