...
Feature: Litigator completes hardship claims
  ...
  Scenario: I create a litigator hardship claim where evidence was served
    ...
    Then the hardship fee amount should be populated with '234.97'
    ...
    And I should see 'Net amount £234.97'
    ...
    And Claim 'A20201234' should be listed with a status of 'Submitted' and a claimed amount of '£234.97'

  @fee_calc_vcr
  Scenario: I create a litigator hardship claim where no evidence was served
    ...
    Given I insert the VCR cassette 'features/claims/litigator/hardship_fee_calculations_without_evidence'

    And I should see a page title "Enter offence details for litigator hardship fees claim"
    When I click "Continue" in the claim form

    And I should be in the 'Hardship fee' form page
    Then I should not see 'Total pages of evidence'
    Then the hardship fee amount should be populated with '117.49'
    And I eject the VCR cassette
    ...
    And I should see 'Hardship fees'
    And I should not see 'PPE total at the time'
    And I should see 'Net amount £117.49'
    ...
    When I click View your claims
    Then I should be on the your claims page
    And Claim 'A20201234' should be listed with a status of 'Submitted' and a claimed amount of '£117.49'
