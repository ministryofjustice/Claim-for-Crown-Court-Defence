...
Feature: Litigator completes hardship claims
  ...
  Scenario: I create a litigator hardship claim where evidence was served
    ...
    Then the hardship fee amount should be populated with '468.66'
    ...
    And I should see 'Net amount £468.66'
    ...
    And Claim 'A20201234' should be listed with a status of 'Submitted' and a claimed amount of '£468.66'
