...
Feature: Litigator fills out a draft final fee claim and submits it
  ...
  Scenario: I create and submit a final fee claim
    ...
    Then the graduated fee amount should be populated with '547.18'
    When I enter '51' in the PPE total graduated fee field
    Then the graduated fee amount should be populated with '554.49'
    ...
    And I should see the field 'Net amount' with value '£554.49' in 'Graduated fee'
    ...
    And Claim 'A20161234' should be listed with a status of 'Submitted' and a claimed amount of '£961.83'
