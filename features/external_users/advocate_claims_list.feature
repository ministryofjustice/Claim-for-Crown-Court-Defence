...
Feature: Advocate claims list
  ...
  #TODO Refactor to setup all the number of claims before checking the page for the number of claims
  @admin
  Scenario Outline: View claims
    Given I am a signed in advocate admin
     ...
     Examples: Number of claims to create and the expected number of claims seen
       | state                      | number |
       | "submitted"                | 3      |
       | "rejected"                 | 3      |
       | "part_authorised"          | 3      |
