@javascript @no-seed
Feature: Create, edit and delete AGFS external users
  ...
  # Scenario: External user admin creates a new advocate user on api-sandbox

  # Scenario: Case worker admin creates a new advocate user

  # Scenario: Self sign up on api-sandbox
