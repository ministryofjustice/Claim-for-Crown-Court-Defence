...
namespace :db do
  namespace :agfs_scheme_fourteen do
    ...
    desc 'Create the db structures and records required for AGFS Fee Scheme 14 (Section 28 - February 2023), pass \'true\' to run'
    ...
    desc 'Destroy the db structures and records required for AGFS Fee Scheme 14 (Section 28 - February 2023), pass \'true\' to run'
