...
namespace :db do
  namespace :agfs_scheme_sixteen do
    desc 'Display the status of db structures and records for AGFS Fee Scheme 16'
    task status: :environment do
      adder = Seeds::Schemas::AddAGFSFeeScheme16.new(pretend: false)
      puts adder.status
    end

    desc 'Create the db structures and records required for AGFS Fee Scheme 16 (Section 28 Fee Increase - November 2023), pass \'true\' to run'
    ...
    desc 'Destroy the db structures and records required for AGFS Fee Scheme 16 (Section 28 Fee Increase - November 2023), pass \'true\' to run'
