...
describe API::Entities::CCLF::CaseType do
  ...
  context 'delegation' do
    let(:claim) { instance_double(Claim::LitigatorClaim, case_type:, interim?: false, transfer?: false, hardship?: false) }
  ...
  context 'for interim claims with an interim fee other than warrant or disbursement only' do
    ...
    let(:claim) { instance_double(Claim::InterimClaim, case_type:, interim?: true, transfer?: false, hardship?: false, interim_fee: fee) }
  ...
  context 'for transfer claims' do
    let(:claim) { instance_double(Claim::TransferClaim, case_type:, interim?: false, transfer?: true, hardship?: false, transfer_detail:) }
