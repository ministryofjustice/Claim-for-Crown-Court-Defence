...
describe API::Entities::SearchResult do
  ...
  describe 'filters' do
    ...
    context 'when passed a submitted case with a graduated fee ' do
      ...
      let(:result) { {'disk_evidence'=>false, 'redetermination'=>false, 'fixed_fee'=>false, 'awaiting_written_reasons'=>false, 'cracked'=>false, 'trial'=>false, 'guilty_plea'=>false, 'graduated_fees'=>true, 'interim_fees'=>false, 'warrants'=>false, 'interim_disbursements'=>false, 'risk_based_bills'=>false} }
    ...
    context 'when passed a redetermination case with a graduated fee ' do
      ...
      let(:result) { {'disk_evidence'=>false, 'redetermination'=>true, 'fixed_fee'=>false, 'awaiting_written_reasons'=>false, 'cracked'=>false, 'trial'=>false, 'guilty_plea'=>false, 'graduated_fees'=>false, 'interim_fees'=>false, 'warrants'=>false, 'interim_disbursements'=>false, 'risk_based_bills'=>false} }
