...
RSpec.describe API::V1::ExternalUsers::Claims::AdvocateClaim do
  ...
  it_behaves_like 'a deprecated claim endpoint', relative_endpoint: :advocate, action: :validate, deprecation_datetime: Time.new(2021, 5, 31)
  it_behaves_like 'a deprecated claim endpoint', relative_endpoint: :advocate, action: :create, deprecation_datetime: Time.new(2021, 5, 31)
