...
RSpec.describe Advocates::Admin::AdvocatesController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it 'renders breadcrumbs' do
      expect(response.body).to match(/Dashboard.*Advocates.*#{Regexp.escape(subject.name)}/)
    end
  end
  ...
  describe "GET #edit" do
    ...
    it 'renders breadcrumbs' do
      expect(response.body).to match(/Dashboard.*Advocates.*#{Regexp.escape(subject.name)}.*Edit/)
    end
  end
