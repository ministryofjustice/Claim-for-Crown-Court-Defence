...
RSpec.describe Advocates::ClaimsController, type: :controller, focus: true do
  ...
  describe "GET #show" do
    ...
    it 'renders breadcrumbs' do
      expect(response.body).to match(/Dashboard.*Claim: #{Regexp.quote(subject.case_number)}/)
    end
  ...
  describe "GET #edit" do
    ...
    context 'editable claim' do
      ...
      it 'renders breadcrumbs' do
        expect(response.body).to match(/Dashboard.*Claim: #{Regexp.quote(subject.case_number)}.*Edit/)
      end
    end
