...
RSpec.describe CaseWorkers::Admin::CaseWorkersController, type: :controller do
  ...
  describe "GET #show" do
    ...
    it 'renders breadcrumbs' do
      expect(response.body).to match(/Dashboard.*#{Regexp.escape(subject.name)}/)
    end
  end
  ...
  describe "GET #edit" do
    ...
    it 'renders breadcrumbs' do
      expect(response.body).to match(/Dashboard.*#{Regexp.escape(subject.name)}.*Edit/)
    end
  end
  ...
  describe "GET #allocate" do
    ...
    it 'renders breadcrumbs' do
      expect(response.body).to match(/Dashboard.*#{Regexp.escape(subject.name)}.*Allocate/)
    end
  end
