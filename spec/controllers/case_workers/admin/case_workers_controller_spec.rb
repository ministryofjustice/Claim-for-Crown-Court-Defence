...
RSpec.describe CaseWorkers::Admin::CaseWorkersController do
  ...
  describe 'PUT #update_password' do
    ...
    context 'when valid' do
      before do
        put :update_password, params: { id: subject, case_worker: { user_attributes: { current_password: 'TestingPassword', password: 'password5678', password_confirmation: 'password5678' } } }
      end
