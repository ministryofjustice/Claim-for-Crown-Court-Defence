...
RSpec.describe ExternalUsers::Admin::ExternalUsersController do
  ...
  context 'admin user' do
      ...
      context 'when valid' do
        ...
        it 'displays a success notification' do
          params = {
            external_user: {
              user_attributes: {
                email: 'foo@foobar.com', password: 'TestingPassword', password_confirmation: 'TestingPassword', first_name: 'John', last_name: 'Smith'
              },
              roles: ['advocate'],
          ...
          expect {
            post :create,
                 params: { external_user: {
                   user_attributes: { email: 'foo@foobar.com', password: 'TestingPassword',
    ...
    describe 'PUT #update_password' do
      before do
        subject.user.update(password: 'TestingPassword', password_confirmation: 'TestingPassword')
      ...
      context 'when valid' do
        before do
          put :update_password,
              params: { id: subject,
                        external_user: { user_attributes: { current_password: 'TestingPassword', password: 'password5678',
                                                            password_confirmation: 'password5678' } } }
        end

        it 'redirects to external_user show action' do
          # put :update_password, id: external_user, external_user: { user_attributes: { current_password: 'TestingPassword', password: 'password5678', password_confirmation: 'password5678' } }
