...
RSpec.describe SuperAdmins::Admin::SuperAdminsController do
  ...
  describe 'PUT #update_password' do
    ...
    context 'when valid' do
      before { put :update_password, params: { id: subject, super_admin: { user_attributes: { current_password: 'TestingPassword', password: 'password5678', password_confirmation: 'password5678' } } } }
  ...
  describe 'PUT #update' do
    before do
      put :update, params: { id: subject, super_admin: { user_attributes: { first_name: 'Joshua', last_name: 'Dude', password: 'TestingPassword', email: 'superadmin@bigblackhhole.com' } } }
    end
