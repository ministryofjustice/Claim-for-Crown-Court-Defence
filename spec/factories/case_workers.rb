  ...
  factory :case_worker do
    ...
    after(:build) do |case_worker, evaluator|
      if evaluator.build_user
        case_worker.user ||= build(:user, first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, password: 'TestingPassword', password_confirmation: 'TestingPassword')
