  ...
  factory :external_user do
    ...
    after(:build) do |eu, evaluator|
      if evaluator.build_user
        eu.user ||= build(:user, first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, email: Faker::Internet.unique.email, password: 'TestingPassword', password_confirmation: 'TestingPassword')
      end
    end
