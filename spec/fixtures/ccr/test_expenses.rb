  ...
  module TestExpenses
    ...
    def for_parking
      [
        ...
        { source_expense: { location: nil, quantity: nil, rate: nil, amount: 27, reason_id: 3, reason_text: nil, schema_version: 2, distance: nil, mileage_rate_id: nil, date: '2014-09-03', hours: nil, vat_amount: 5.4 }, expected_return: { bill_type: 'AGFS_EXPENSES', bill_subtype: 'AGFS_TCT_TRV_CR', date_incurred: '2014-09-03', description: 'Parking', quantity: '1', rate: '27' } },
