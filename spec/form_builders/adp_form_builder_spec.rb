...
describe AdpFormBuilder do
  ...
  describe 'anchored_label' do
    context 'no anchor name supplied' do
      it 'should take the label as the anchor name' do
        expected_html = %[<a name="advocate_category"></a><label for="claim_advocate_category">Advocate category</label>]
    ...
    context 'anchor name supplied' do
      it 'should use anchor name supplied' do
        expected_html = %[<a name="ad_cat"></a><label for="claim_ad_cat">Advocate category</label>]
    ...
    context 'extra html attributes supplied' do
      it 'should use the attributes when anchor name supplied' do
        expected_html = %[<a name="ad_cat" class="red"></a><label class="blue" for="claim_ad_cat">Advocate category</label>]
      ...
      it 'should use the attributes when no anchor name provided' do
        expected_html = %[<a name="advocate_category" class="red"></a><label class="blue" for="claim_advocate_category">Advocate category</label>]
  ...
  describe 'anchored_without_label' do
    context 'no anchor name supplied' do
      it 'should take the label as the anchor name' do
        expected_html = %[<a name="advocate_category"></a>]
    ...
    context 'extra html attributes supplied' do
      it 'should use the attributes' do
        expected_html = %[<a name="ad_cat" class="red"></a>]
