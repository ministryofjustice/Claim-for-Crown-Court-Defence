describe('Modules.CocoonHelper.js', function () {
  it('should exist with some config', function () {
    const module = moj.Modules.CocoonHelper
    expect(module.el).toBe('#basic-fees,#misc-fees,#fixed-fees,#graduated-fees,#disbursements,#interim-fee,#warrant_fee,#transfer-fee')
