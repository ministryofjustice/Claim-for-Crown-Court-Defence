...
RSpec.describe Fee::BaseFeeType do
  ...
  it { is_expected.to respond_to(:lgfs?, :lgfs_scheme_9?, :lgfs_scheme_10?, :lgfs_scheme_11?, :agfs?, :agfs_scheme_9?, :agfs_scheme_10?, :agfs_scheme_12?, :agfs_scheme_13?, :agfs_scheme_14?, :agfs_scheme_15?, :agfs_scheme_16?, :agfs_scheme_17?) }
  it { expect(described_class).to respond_to(:lgfs, :lgfs_scheme_9s, :lgfs_scheme_10s, :lgfs_scheme_11s, :agfs, :agfs_scheme_9s, :agfs_scheme_10s, :agfs_scheme_12s, :agfs_scheme_13s, :agfs_scheme_14s, :agfs_scheme_15s, :agfs_scheme_16s, :agfs_scheme_17s) }
  ...
  context 'when calling scheme role scope' do
    before do
      ...
      create(:misc_fee_type, description: 'LGFS Scheme 10 and 11 roles', roles: %w[lgfs lgfs_scheme_10 lgfs_scheme_11])
    end
    ...
    describe '.lgfs_scheme_10s' do
      ...
      it { is_expected.to contain_exactly('LGFS Scheme 9, 10 and 11 roles', 'LGFS Scheme 10 and 11 roles') }
    end
