...
RSpec.describe Fee::BaseFeeType do
  ...
  it { is_expected.to respond_to(:lgfs?, :lgfs_scheme_9?, :lgfs_scheme_10?, :agfs?, :agfs_scheme_9?, :agfs_scheme_10?, :agfs_scheme_12?, :agfs_scheme_13?, :agfs_scheme_14?, :agfs_scheme_15?) }
  it { expect(described_class).to respond_to(:lgfs, :lgfs_scheme_9s, :lgfs_scheme_10s, :agfs, :agfs_scheme_9s, :agfs_scheme_10s, :agfs_scheme_12s, :agfs_scheme_13s, :agfs_scheme_14s, :agfs_scheme_15s) }
