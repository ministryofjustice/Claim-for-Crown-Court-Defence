...
RSpec.describe Fee::BaseFeeType do
  ...
  it { expect(described_class).to respond_to(:lgfs, :lgfs_scheme_9s, :lgfs_scheme_10s, :agfs, :agfs_scheme_9s, :agfs_scheme_10s, :agfs_scheme_12s, :agfs_scheme_13s, :agfs_scheme_14s, :agfs_scheme_15s, :agfs_scheme_16?) }
