...
module CCR
  ...
  describe ExpensesAdapter do
    ...
    describe 'car travel' do
      TestData.for_car_travel.each do |row|
    ...
    describe 'parking' do
      TestData.for_parking.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'hotel accommodation' do
      TestData.for_hotel_accommodation.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'train transport' do
      TestData.for_train_public_transport.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'travel time' do
      TestData.for_travel_time.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'road and tunnel tolls' do
      TestData.for_road_or_tunnel_tolls.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'cab fares' do
      TestData.for_cab_fares.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'subsistence' do
      TestData.for_subsistence.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
    ...
    describe 'bicycle travel' do
      TestData.for_bike_travel.each do |row|
        context "with reason_id of #{row[:source_expense][:reason_id]}" do
          let(:test) { row }
