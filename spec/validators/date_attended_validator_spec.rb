...
#     context "earliest permitted date boundary" do
#     let(:attendance_date) { Settings.earliest_permitted_date - 2.day }
#     puts "Testing with attendance date: #{attendance_date} and earliest permitted date: #{Settings.earliest_permitted_date}"
