  ...
  context 'with fee summaries' do
    ...
    context 'with an LGFS claim' do
      ...
      context 'with a fixed fee' do
        ...
        it 'does not display unrelated table headers' do
          within '.fees-summary' do |summary|
            expect(summary).not_to include_table_headers('Actual trial length')
          end
        end
      end
      ...
      context 'with an interim fee' do
        ...
        it 'displays expected table headers' do
          within '.fees-summary' do |summary|
            expect(summary).to include_table_headers('Fee category', 'Fee type', 'Fee category', 'Amount')
          end
        end
